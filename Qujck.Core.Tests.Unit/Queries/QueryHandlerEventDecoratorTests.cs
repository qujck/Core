...
namespace Qujck.Core.Tests.Unit.Queries
{
    public class QueryHandlerEventDecoratorTests
    {
        ...
        public void Handle_CallsAllBeforeEventHandlers_BeforeCallingDecoratedInstance()
        {
            ...
            var decoratedInstance = new StubQueryHandler<FakeQuery, FakeResult>(
                () => called = true);
        ...
        private QueryHandlerEventDecorator<FakeQuery, FakeResult> DecoratorFactory(
            IQueryHandler<FakeQuery, FakeResult> decoratedInstance,
        ...
        {
            return new QueryHandlerEventDecorator<FakeQuery, FakeResult>(
                decoratedInstance ?? new StubQueryHandler<FakeQuery, FakeResult>(),
        ...
        private class FakeQuery : IQuery<FakeResult> { }
